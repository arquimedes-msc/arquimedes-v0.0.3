...
export function useConfetti() {
  ...
  /**
   * Confete de conquista (explosão grande)
   */
  ...
  /**
   * Confete de level-up (chuva dourada)
   */
  ...
  /**
   * Confete de estrelas (para módulo completo)
   */
